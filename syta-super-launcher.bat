...
set "SYTA_SELF=%~f0"
set "SYTA_BUILD_ID=SYTA-build-2026-09-07-211842Z"
...
::     [string]$Agent,
::     [ValidateSet('first-install', 'wsl-ubuntu', 'powershell-7', 'extra', 'all-ai-cli-tools', 'cleaner-helper', 'reset-tool-configs', 'utilities', 'codex', 'opencode', 'kilocode-cli', 'claude-code', 'gemini-cli', 'droid-cli', 'grok-cli', 'command-code', 'reasonix', 'pi', 'omp', 'zcode', 'dsh', 'muse-code', 'oh-my-openagent', 'oh-my-opencode-slim', 'utility-rtk', 'utility-ccusage', 'utility-codex-auth', 'utility-superpowers', 'utility-openspec', 'utility-claw-code', 'utility-bmad', 'utility-patchright')]
...
:: $script:BuildId = 'SYTA-build-2026-09-07-211842Z'
:: $script:ReleaseTag = 'v1.12.0'
...
::                     [pscustomobject]@{ Title = 'Utilitaires et add-ons | a quoi ils servent'; Subtitle = 'RTK, ccusage, codex-auth, superpowers, OpenSpec, Claw Code, BMAD, Patchright et les extras similaires.'; Accent = 'Magenta'; Key = 'utilities' }
...
::                     [pscustomobject]@{ Title = '实用工具和扩展 | 各自做什么'; Subtitle = 'RTK、ccusage、codex-auth、superpowers、OpenSpec、Claw Code、BMAD、Patchright 这类附加工具。'; Accent = 'Magenta'; Key = 'utilities' }
...
::                     [pscustomobject]@{ Title = 'Utilities and add-ons | what they do'; Subtitle = 'RTK, ccusage, codex-auth, superpowers, OpenSpec, Claw Code, BMAD, Patchright, and similar extras.'; Accent = 'Magenta'; Key = 'utilities' }
